...
- Rohes Feedback kommt aus `input/raw_feedback/`
...
Sobald der Nutzer "starte den MCP-Kurs", "MCP-Kurs", "kurs-mcp" oder ähnliches sagt — führe `/kurs-mcp` aus. Starte ohne Vorrede.
